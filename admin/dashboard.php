...
$c_toledo = $customer->findAllBy('city', 'Toledo');
$c_aloguinsan = $customer->findAllBy('city', 'Aloguinsan');
$c_pinamungajan = $customer->findAllBy('city', 'Pinamungajan');
$c_asturias = $customer->findAllBy('city', 'Asturias');
$c_balamban = $customer->findAllBy('city', 'Balamban');
$c_cebu = $customer->findAllBy('city', 'Cebu');
?>
        ...
        <div class="tab-content pt-2" id="borderedTabJustifiedContent">
            <div class="tab-pane fade show active" id="bordered-justified-toledo" role="tabpanel"
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="toledo_table" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
            ...
            <div class="tab-pane fade" id="bordered-justified-aloguinsan" role="tabpanel"
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="aloguinsan_table" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Account Number</th>
            ...
            <div class="tab-pane fade" id="bordered-justified-pinamungajan" role="tabpanel"
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="pinamungajan_table" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Account Number</th>
            ...
            <div class="tab-pane fade" id="bordered-justified-asturias" role="tabpanel" aria-labelledby="asturias-tab">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="asturias_table" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Account Number</th>
            ...
            <div class="tab-pane fade" id="bordered-justified-balamban" role="tabpanel" aria-labelledby="balamban-tab">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="balamban_table" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Account Number</th>
            ...
            <div class="tab-pane fade" id="bordered-justified-cebu" role="tabpanel" aria-labelledby="cebu-tab">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="cebu_city_table" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Account Number</th>
